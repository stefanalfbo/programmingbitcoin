...
func TestBlock(t *testing.T) {
	...
	t.Run("ParseBlock return block with correct values", func(t *testing.T) {
		...
		if !bytes.Equal(block.PreviousBlock[:], []byte{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0xab, 0x28, 0x36, 0x00, 0x03, 0x58, 0x42, 0x6e, 0xd7, 0x9e, 0x26, 0x94, 0xe6, 0x66, 0x75, 0xa3, 0x05, 0xd2, 0x4f, 0x66, 0x89, 0xcd, 0x1e}) {
			t.Errorf("expected previous block to be 29decabf, got %x", block.PreviousBlock)
		}
