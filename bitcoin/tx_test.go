...
func TestTx(t *testing.T) {
	...
	t.Run("CoinbaseHeight on a non coinbase transaction", func(t *testing.T) {
		stream := setup()
		tx, err := bitcoin.Parse(stream, false)
		if err != nil {
			t.Errorf("unexpected error: %v", err)
		...
		_, err = tx.CoinbaseHeight()
		if err == nil {
			t.Errorf("expected an error")
		}
	})

	t.Run("CoinbaseHeight on a coinbase transaction", func(t *testing.T) {
		var expected int32 = 465879
		hexString := ""
		...
		if height != expected {
			t.Errorf("expected: %d, got: %d", expected, height)
		}
	})
}
