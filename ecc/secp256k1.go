...
type Secp256k1Type struct {
	Gx, Gy, Prime, A, B, N *big.Int
}

var Secp256k1 = &Secp256k1Type{
	...
	Prime: new(big.Int).SetBytes([]byte{0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xfe, 0xff, 0xff, 0xfc, 0x2f}),
	A:     big.NewInt(0),
	B:     big.NewInt(7),
